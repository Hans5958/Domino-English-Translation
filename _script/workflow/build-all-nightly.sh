...
echo "Building 1.45 dev003 (32-bit) (nightly version)..."
...
cat >temp/compile-config.json <<EOL
{
	...
	"fullVersion": "1.45 dev003-en.$VERSION_NUM-nightly.$BUILD_DATE",
	"buildVersion": "$VERSION_NUM"-nightly.$BUILD_DATE,
...
echo "Building 1.45 dev003 (64-bit) (nightly version)..."
